# FusionFirst Workshop — Package Guide
...
- Accent: `#E8A04A` (amber) — primary actions, links, focal elements
- Signals: `#5EBA82` (green), `#EB5757` (red), `#6F8FE8` (blue) — data visualization
...
- This system is opt-in — only use for FusionFirst Workshop brand projects.
...
- Avoid applying this system to non-FusionFirst Workshop projects.
